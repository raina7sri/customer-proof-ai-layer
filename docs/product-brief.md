...
The original build brief for the Customer Proof AI Layer — the design system, product
positioning, and governance rules the app was built against. Kept in the repo as the
spec of record: if a change contradicts something here, one of the two is wrong.

Applies the Aurics visual system and product direction.
